...
\title{Domain-Adapted PPE Compliance Detection for an Operating Chemical Plant CCTV Network}
...
\begin{IEEEkeywords}
PPE compliance, YOLOv8, domain adaptation, chemical industry, vigilance decrement, CCTV retrofitting
\end{IEEEkeywords}
