...
```python
ROBOFLOW_API_KEY = "uOeiTcR9AzipAJhnPz62"        # user fills (free account)
KAGGLE_USERNAME  = "yasserdalali"        # user fills (SH17 original)
KAGGLE_KEY       = "KGAT_3ade4fff3f30c9029f0b98fb490fc8d9"
...
Duplication factors live in config.
...
with Model B's actual class list), compute P / R / mAP50 with the `supervision`
library. Same metric code for both models.
